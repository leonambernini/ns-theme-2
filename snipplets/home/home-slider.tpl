<section class="js-home-slider-container section-slider d-none d-md-block {% if not settings.slider or settings.slider is empty %} hidden {% endif %}" data-store="slider-main">
	<div class="js-home-slider swiper-container swiper-container-horizontal">
		...
		<div class="js-swiper-home-prev swiper-button-prev d-none d-md-block">{% include "snipplets/svg/chevron-left.tpl" with {svg_custom_class: "icon-inline icon-w-16 icon-lg svg-icon-invert"} %}</div>
		<div class="js-swiper-home-next swiper-button-next d-none d-md-block">{% include "snipplets/svg/chevron-right.tpl" with {svg_custom_class: "icon-inline icon-w-16 icon-lg svg-icon-invert"} %}</div>
	</div>
</section>
