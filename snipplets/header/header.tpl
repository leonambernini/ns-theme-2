    ...
    <div class="header-primary">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <div class="header-nav-mobile d-block d-lg-none order-1 order-lg-1">{% snipplet "navigation/navigation.tpl" %}</div>
                
                <div class="header-logo mr-auto ml-auto ml-lg-0 order-3 order-lg-2">{% snipplet "header/header-logo.tpl" %}</div>
                
                <nav class="header-desktop-nav align-self-stretch d-none d-lg-block order-4 order-lg-3">
                    <ul class="d-flex justify-content-center align-items-center h-100-pct">
                        {% include "snipplets/navigation/navigation-nav-list.tpl" with {desktop: true} %}
                    </ul>
                </nav>

                <div class="header-search d-none d-md-block flex-fill order-6 order-lg-4">
                    {% snipplet "header/header-search.tpl" %}
                </div>

                <div class="header-search-mobile d-block d-md-none order-5">
                ...
                <div class="header-account order-2 order-lg-6">
