...
{% set has_footer_categories = settings.footer_categories %}
	...
	<div class="footer-navs {% if settings.footer_mobile_hide %}footer-navs-hide-mobile{% endif %}">
		<div class="container">
			...
			<div class="d-flex justify-content-center flex-wrap">
				...
				{% if template != 'password' %}
					...
					{% if has_footer_menu %}
						<div class="footer-navs-institucional js-footer-mobile-box">
							...
							<div class="js-footer-mobile-content">
								{% include "snipplets/navigation/navigation-foot.tpl" with {menu: settings.footer_menu} %}
							</div>
						</div>
					{% endif %}

					{# Foot Nav #}
					{% if has_footer_categories %}
						<div class="footer-navs-institucional js-footer-mobile-box">
							<h4 class="js-footer-mobile-title">
								{% if settings.footer_categories_title %}
									{{ settings.footer_categories_title }}
								{% else %}
									Departamentos
								{% endif %}
							</h4>
							<div class="js-footer-mobile-content">
								{% include "snipplets/navigation/navigation-foot.tpl" with {menu: settings.footer_categories} %}
							</div>
						</div>
					{% endif %}
				...
				{% if has_payment_logos or has_shipping_logos %}
					<div class="footer-navs-payments-shipping">
